-- CreateEnum
CREATE TYPE "RoleName" AS ENUM ('CUSTOMER', 'AGENT', 'SENIOR_AGENT', 'MANAGER', 'ADMIN');

-- CreateEnum
CREATE TYPE "UserStatus" AS ENUM ('PENDING_VERIFICATION', 'INVITED', 'ACTIVE', 'SUSPENDED', 'DEACTIVATED');
